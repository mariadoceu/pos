...
public class BDVeiculos {
	...
	//Criar dois vetores
	public static Passeio vetorPasseio[] = new Passeio[5];
	public static Carga vetorCarga[] = new Carga[5];
	...
	public static int verificaPosicaoCarga() {
		...
		public static boolean placaPasseioAlocada(String placa) throws  VeicExistException{
			...
			for(int i = 0; i <vetorPasseio.length;i++) {
				...
				if(vetorPasseio[i] != null && vetorPasseio[i].getPlaca().contains(placa) && placa != "") {
					return true;
				}
				
				if(vetorPasseio[i] != null && vetorPasseio[i].getPlaca().contains(placa)) {
		...
		public static boolean placaCargaAlocada(String placa) throws VeicExistException{
			for(int i = 0; i <vetorCarga.length;i++) {
				if(vetorCarga[i] != null && vetorCarga[i].getPlaca().contains(placa) && placa != "") {
					return true;
				}
			}
			return false;
